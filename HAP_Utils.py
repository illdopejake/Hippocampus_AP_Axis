...
#################################################################################
# The following was copied directly from a github repo, which can be found here:
# https://github.com/psinger/CorrelationStats/blob/master/corrstats.py
# I opted to simply copy the code into here for easier portability, (rather
# than have the user go and download yet another git repo). 

# I had no part in writing this whatsoever.
#################################################################################
